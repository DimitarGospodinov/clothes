...
clothes = sqlalchemy.Table(
    ...
    sqlalchemy.Column("color", sqlalchemy.Enum(ColorEnum, name="color"), nullable=False),
    sqlalchemy.Column("size", sqlalchemy.Enum(SizeEnum, name="size"),nullable=False),
...
class BaseUser(pydantic.BaseModel):
    ...
    def validate_full_name(cls, v):
        try: 
            first_name, second_name = v.split()
            return v
        except Exception:
